...
int main() {
    _int_100b a = "FFFFFFFFFFFFFFFFFFFFFFFFF";
    cout<< "Unsigned : "; a.printUDecimalNum();
    cout<< "Signed   : "; a.printDecimalNum();
    cout<< "Hex      : "; a.printHexNum();
    cout<<endl;

    _int_100b b = "AFFDFA123AD980137FFFFFFF1";
    cout<< "Unsigned : "; b.printUDecimalNum();
    cout<< "Signed   : "; b.printDecimalNum();
    cout<< "Hex      : "; b.printHexNum();
    cout<<endl;
